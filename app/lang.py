...
PHRASES: dict[str, dict[str, str]] = {
    ...
    "imd_storm": {
        "bn": "এই সমুদ্র এলাকার জন্য IMD ঝড়ের সতর্কতা জারি করেছে — সমুদ্রে যাবেন না",
        "hi": "इस समुद्री क्षेत्र के लिए IMD ने तूफान की चेतावनी जारी की है — समुद्र में न जाएँ",
        "mr": "या सागरी भागासाठी IMD ने वादळाचा इशारा दिला आहे — समुद्रात जाऊ नका",
        "gu": "આ દરિયાઈ વિસ્તાર માટે IMD એ વાવાઝોડાની ચેતવણી આપી છે — દરિયામાં ન જશો",
        "or": "ଏହି ସାମୁଦ୍ରିକ ଅଞ୍ଚଳ ପାଇଁ IMD ଝଡ଼ର ଚେତାବନୀ ଜାରି କରିଛି — ସମୁଦ୍ରକୁ ଯାଆନ୍ତୁ ନାହିଁ",
        "ta": "இந்தக் கடல் பகுதிக்கு IMD புயல் எச்சரிக்கை விடுத்துள்ளது — கடலுக்குச் செல்ல வேண்டாம்",
        "te": "ఈ సముద్ర ప్రాంతానికి IMD తుఫాను హెచ్చరిక జారీ చేసింది — సముద్రంలోకి వెళ్లవద్దు",
        "ml": "ഈ കടൽ മേഖലയ്ക്ക് IMD കൊടുങ്കാറ്റ് മുന്നറിയിപ്പ് നൽകിയിട്ടുണ്ട് — കടലിൽ പോകരുത്",
        "en": "IMD has issued a storm warning for this sea area — do not go out",
    },
    "sst": {
    ...
    "trend_down": {
        "bn": "গত বছরের তুলনায় জলে প্ল্যাঙ্কটন {pct}% কম — মাছ কম থাকার একটা কারণ হতে পারে",
        "hi": "पिछले साल की तुलना में पानी में प्लवक {pct}% कम — मछली कम होने का एक कारण हो सकता है",
        "mr": "गेल्या वर्षीच्या तुलनेत पाण्यात प्लवक {pct}% कमी — मासे कमी असण्याचे एक कारण असू शकते",
        "gu": "ગયા વર્ષની સરખામણીએ પાણીમાં પ્લવક {pct}% ઓછું — માછલી ઓછી હોવાનું એક કારણ હોઈ શકે",
        "or": "ଗତ ବର୍ଷ ତୁଳନାରେ ଜଳରେ ପ୍ଲାଙ୍କଟନ {pct}% କମ — ମାଛ କମ ରହିବାର ଏକ କାରଣ ହୋଇପାରେ",
        "ta": "கடந்த ஆண்டை விட நீரில் பிளாங்க்டன் {pct}% குறைவு — மீன் குறைவதற்கு ஒரு காரணமாக இருக்கலாம்",
        "te": "గత సంవత్సరంతో పోలిస్తే నీటిలో ప్లవకాలు {pct}% తక్కువ — చేపలు తగ్గడానికి ఒక కారణం కావచ్చు",
        "ml": "കഴിഞ്ഞ വർഷത്തേക്കാൾ വെള്ളത്തിൽ പ്ലവകങ്ങൾ {pct}% കുറവ് — മീൻ കുറയാനുള്ള ഒരു കാരണമാകാം",
        "en": "plankton in the water is {pct}% lower than this time last year — one possible reason for fewer fish",
    },
    "trend_up": {
        "bn": "গত বছরের তুলনায় জলে প্ল্যাঙ্কটন {pct}% বেশি",
        "hi": "पिछले साल की तुलना में पानी में प्लवक {pct}% अधिक",
        "mr": "गेल्या वर्षीच्या तुलनेत पाण्यात प्लवक {pct}% जास्त",
        "gu": "ગયા વર્ષની સરખામણીએ પાણીમાં પ્લવક {pct}% વધુ",
        "or": "ଗତ ବର୍ଷ ତୁଳନାରେ ଜଳରେ ପ୍ଲାଙ୍କଟନ {pct}% ଅଧିକ",
        "ta": "கடந்த ஆண்டை விட நீரில் பிளாங்க்டன் {pct}% அதிகம்",
        "te": "గత సంవత్సరంతో పోలిస్తే నీటిలో ప్లవకాలు {pct}% ఎక్కువ",
        "ml": "കഴിഞ്ഞ വർഷത്തേക്കാൾ വെള്ളത്തിൽ പ്ലവകങ്ങൾ {pct}% കൂടുതൽ",
        "en": "plankton in the water is {pct}% higher than this time last year",
    },
    "trend_steady": {
        "bn": "গত বছরের তুলনায় জলে প্ল্যাঙ্কটন প্রায় একই",
        "hi": "पिछले साल की तुलना में पानी में प्लवक लगभग समान",
        "mr": "गेल्या वर्षीच्या तुलनेत पाण्यात प्लवक जवळपास सारखेच",
        "gu": "ગયા વર્ષની સરખામણીએ પાણીમાં પ્લવક લગભગ સરખું",
        "or": "ଗତ ବର୍ଷ ତୁଳନାରେ ଜଳରେ ପ୍ଲାଙ୍କଟନ ପ୍ରାୟ ସମାନ",
        "ta": "கடந்த ஆண்டைப் போலவே நீரில் பிளாங்க்டன் ஏறக்குறைய சமம்",
        "te": "గత సంవత్సరంతో పోలిస్తే నీటిలో ప్లవకాలు దాదాపు సమానం",
        "ml": "കഴിഞ്ഞ വർഷത്തേതിന് സമാനമായി വെള്ളത്തിൽ പ്ലവകങ്ങൾ ഏകദേശം തുല്യം",
        "en": "plankton in the water is about the same as this time last year",
    },
    "trend_limits": {
        "bn": "উপগ্রহ শুধু জল দেখে — কত নৌকা নেমেছে, কে কত ধরেছে, জাল কেমন, এসব এতে নেই",
        "hi": "उपग्रह केवल पानी देखता है — कितनी नावें गईं, किसने कितना पकड़ा, जाल कैसा, यह इसमें नहीं",
        "mr": "उपग्रह फक्त पाणी पाहतो — किती नावा गेल्या, कोणी किती पकडले, जाळे कसे, हे यात नाही",
        "gu": "ઉપગ્રહ માત્ર પાણી જુએ છે — કેટલી હોડીઓ ગઈ, કોણે કેટલું પકડ્યું, જાળ કેવી, એ આમાં નથી",
        "or": "ଉପଗ୍ରହ କେବଳ ଜଳ ଦେଖେ — କେତେ ଡଙ୍ଗା ଗଲା, କିଏ କେତେ ଧରିଲା, ଜାଲ କେମିତି, ଏସବୁ ଏଥିରେ ନାହିଁ",
        "ta": "செயற்கைக்கோள் நீரை மட்டுமே பார்க்கிறது — எத்தனை படகுகள் சென்றன, யார் எவ்வளவு பிடித்தார்கள், வலை எப்படி, இவை இதில் இல்லை",
        "te": "ఉపగ్రహం నీటిని మాత్రమే చూస్తుంది — ఎన్ని పడవలు వెళ్లాయి, ఎవరు ఎంత పట్టారు, వల ఎలా, ఇవి ఇందులో లేవు",
        "ml": "ഉപഗ്രഹം വെള്ളം മാത്രമേ കാണുന്നുള്ളൂ — എത്ര വള്ളങ്ങൾ പോയി, ആരു എത്ര പിടിച്ചു, വല എങ്ങനെ, ഇവയൊന്നും ഇതിലില്ല",
        "en": "a satellite only sees the water — how many boats went out, who caught what, what gear was used, none of that is in this",
    },
    "trend_nodata": {
        "bn": "গত বছরের তুলনা করার মতো যথেষ্ট ছবি পাওয়া যায়নি",
        "hi": "पिछले साल से तुलना करने के लिए पर्याप्त छवियाँ नहीं मिलीं",
        "mr": "गेल्या वर्षाशी तुलना करण्यासाठी पुरेशी छायाचित्रे मिळाली नाहीत",
        "gu": "ગયા વર્ષ સાથે સરખાવવા પૂરતી છબીઓ મળી નથી",
        "or": "ଗତ ବର୍ଷ ସହ ତୁଳନା କରିବାକୁ ଯଥେଷ୍ଟ ଚିତ୍ର ମିଳିଲା ନାହିଁ",
        "ta": "கடந்த ஆண்டுடன் ஒப்பிட போதுமான படங்கள் கிடைக்கவில்லை",
        "te": "గత సంవత్సరంతో పోల్చడానికి తగినన్ని చిత్రాలు దొరకలేదు",
        "ml": "കഴിഞ്ഞ വർഷവുമായി താരതമ്യം ചെയ്യാൻ വേണ്ടത്ര ചിത്രങ്ങൾ കിട്ടിയില്ല",
        "en": "not enough imagery to compare with last year",
    },
    "trend_caveat": {
        "bn": "এটা জলের হিসেব — মাছ কম পড়ার আরও কারণ থাকতে পারে",
        "hi": "यह पानी का हिसाब है — मछली कम मिलने के और भी कारण हो सकते हैं",
        "mr": "हे पाण्याचे मोजमाप आहे — मासे कमी मिळण्याची इतरही कारणे असू शकतात",
        "gu": "આ પાણીનું માપ છે — માછલી ઓછી મળવાનાં બીજાં કારણો પણ હોઈ શકે",
        "or": "ଏହା ଜଳର ହିସାବ — ମାଛ କମ ମିଳିବାର ଅନ୍ୟ କାରଣ ମଧ୍ୟ ଥାଇପାରେ",
        "ta": "இது நீரின் அளவீடு — மீன் குறைவதற்கு வேறு காரணங்களும் இருக்கலாம்",
        "te": "ఇది నీటి కొలత — చేపలు తగ్గడానికి ఇతర కారణాలూ ఉండవచ్చు",
        "ml": "ഇത് വെള്ളത്തിന്റെ കണക്കാണ് — മീൻ കുറയാൻ മറ്റു കാരണങ്ങളുമുണ്ടാകാം",
        "en": "this is what the water did — a catch can fall for other reasons too",
    },
    "route_direct": {
        "bn": "{dist} কিমি {dir} দিকে সোজা যাওয়া যায় — ঘুরে যাওয়ার দরকার নেই",
        "hi": "{dist} किमी {dir} की ओर सीधे जा सकते हैं — घूमने की ज़रूरत नहीं",
        "mr": "{dist} किमी {dir} दिशेला थेट जाऊ शकता — वळसा घेण्याची गरज नाही",
        "gu": "{dist} કિમી {dir} તરફ સીધા જઈ શકો — ફરવાની જરૂર નથી",
        "or": "{dist} କିମି {dir} ଦିଗକୁ ସିଧା ଯାଇପାରିବେ — ବୁଲିବାର ଆବଶ୍ୟକତା ନାହିଁ",
        "ta": "{dist} கிமீ {dir} திசையில் நேராகச் செல்லலாம் — சுற்ற வேண்டாம்",
        "te": "{dist} కిమీ {dir} వైపు నేరుగా వెళ్లవచ్చు — తిరగాల్సిన అవసరం లేదు",
        "ml": "{dist} കിമീ {dir} ദിശയിൽ നേരെ പോകാം — ചുറ്റിപ്പോകേണ്ട",
        "en": "you can go straight, {dist} km to the {dir} — no detour needed",
    },
    "route_detour": {
        "bn": "{dir} দিকে গিয়ে ঘুরে যান — {dist} কিমি, সোজা পথের চেয়ে {extra} কিমি বেশি, কিন্তু জল শান্ত",
        "hi": "{dir} की ओर घूमकर जाइए — {dist} किमी, सीधे रास्ते से {extra} किमी ज़्यादा, पर पानी शांत",
        "mr": "{dir} दिशेने वळसा घ्या — {dist} किमी, थेट मार्गापेक्षा {extra} किमी जास्त, पण पाणी शांत",
        "gu": "{dir} તરફ ફરીને જાઓ — {dist} કિમી, સીધા રસ્તા કરતાં {extra} કિમી વધુ, પણ પાણી શાંત",
        "or": "{dir} ଦିଗରେ ବୁଲି ଯାଆନ୍ତୁ — {dist} କିମି, ସିଧା ପଥଠାରୁ {extra} କିମି ଅଧିକ, କିନ୍ତୁ ଜଳ ଶାନ୍ତ",
        "ta": "{dir} திசையில் சுற்றிச் செல்லுங்கள் — {dist} கிமீ, நேர்வழியை விட {extra} கிமீ கூடுதல், ஆனால் கடல் அமைதி",
        "te": "{dir} వైపు తిరిగి వెళ్లండి — {dist} కిమీ, నేరుగా వెళ్లే దారి కంటే {extra} కిమీ ఎక్కువ, కానీ నీరు ప్రశాంతం",
        "ml": "{dir} ദിശയിൽ ചുറ്റിപ്പോകുക — {dist} കിമീ, നേർവഴിയേക്കാൾ {extra} കിമീ കൂടുതൽ, പക്ഷേ കടൽ ശാന്തം",
        "en": "go round to the {dir} — {dist} km, {extra} km further than straight, but calmer water",
    },
    "route_limits": {
        "bn": "এটা দিকনির্দেশ, নৌচলাচলের মানচিত্র নয় — গভীরতা, চর, অন্য নৌকা এতে নেই",
        "hi": "यह दिशा का सुझाव है, नौवहन का नक्शा नहीं — गहराई, रेत के टीले, दूसरी नावें इसमें नहीं",
        "mr": "हा दिशेचा सल्ला आहे, नौवहन नकाशा नाही — खोली, वाळूचे बेट, इतर नावा यात नाहीत",
        "gu": "આ દિશાની સલાહ છે, નૌવહન નકશો નથી — ઊંડાઈ, રેતીના ટેકરા, બીજી હોડીઓ આમાં નથી",
        "or": "ଏହା ଦିଗ ପରାମର୍ଶ, ନୌଚଳାଚଳ ମାନଚିତ୍ର ନୁହେଁ — ଗଭୀରତା, ବାଲିଚର, ଅନ୍ୟ ଡଙ୍ଗା ଏଥିରେ ନାହିଁ",
        "ta": "இது திசை ஆலோசனை, கப்பல் வழிகாட்டி வரைபடம் அல்ல — ஆழம், மணல் திட்டு, மற்ற படகுகள் இதில் இல்லை",
        "te": "ఇది దిశా సూచన, నౌకాయాన పటం కాదు — లోతు, ఇసుక దిబ్బలు, ఇతర పడవలు ఇందులో లేవు",
        "ml": "ഇത് ദിശാ നിർദ്ദേശമാണ്, നാവിഗേഷൻ ചാർട്ടല്ല — ആഴം, മണൽത്തിട്ട, മറ്റു വള്ളങ്ങൾ ഇതിലില്ല",
        "en": "this is a direction, not a navigation chart — no depth, no sandbars, no other vessels",
    },
    "mpa_closed": {
