...
# Asked for, not assumed. Everything downstream — the sea area, the fishing
# zone, the boundary — is decided by this one value.
NEED_PLACE = {
    "bn": "আগে আপনার জায়গা বেছে নিন — উপরের তালিকা থেকে বন্দর বাছুন বা 'আমার অবস্থান' চাপুন।",
    "hi": "पहले अपनी जगह चुनें — ऊपर की सूची से बंदरगाह चुनें या 'मेरा स्थान' दबाएँ।",
    "mr": "आधी तुमची जागा निवडा — वरील यादीतून बंदर निवडा किंवा 'माझे स्थान' दाबा.",
    "gu": "પહેલાં તમારી જગ્યા પસંદ કરો — ઉપરની યાદીમાંથી બંદર પસંદ કરો અથવા 'મારું સ્થાન' દબાવો.",
    "or": "ପ୍ରଥମେ ଆପଣଙ୍କ ସ୍ଥାନ ବାଛନ୍ତୁ — ଉପର ତାଲିକାରୁ ବନ୍ଦର ବାଛନ୍ତୁ କିମ୍ବା 'ମୋ ସ୍ଥାନ' ଦବାନ୍ତୁ।",
    "ta": "முதலில் உங்கள் இடத்தைத் தேர்வு செய்யுங்கள் — மேலே உள்ள பட்டியலிலிருந்து துறைமுகத்தைத் தேர்ந்தெடுக்கவும் அல்லது 'என் இடம்' அழுத்தவும்.",
    "te": "ముందుగా మీ ప్రదేశాన్ని ఎంచుకోండి — పై జాబితా నుండి ఓడరేవును ఎంచుకోండి లేదా 'నా స్థానం' నొక్కండి.",
    "ml": "ആദ്യം നിങ്ങളുടെ സ്ഥലം തിരഞ്ഞെടുക്കുക — മുകളിലെ പട്ടികയിൽ നിന്ന് തുറമുഖം തിരഞ്ഞെടുക്കുക അല്ലെങ്കിൽ 'എന്റെ സ്ഥാനം' അമർത്തുക.",
    "en": "Choose your place first — pick a harbour from the list above, or press 'My location'.",
}
